class Game2 extends Phaser.Scene {
    ...
    create() {
        ...
        // Add collider between Jack and tilemap
        this.physics.add.collider(this.enemyGroup, terrainLayer);

        // TEMP
        this.guest = new Enemy(this, 100, 100, 'Jack').setScale(0.5);
        this.guest2 = new Enemy(this, 600, 100, 'Jack').setScale(0.5);
        ...
        // this.map.findObject('spawnLayer', obj => {
        //     if (obj.name.includes('Spawn')) {
        //         this.guest = new Enemy(this, obj.x, obj.y, /* Change to random skin**/'Delbert').setScale(0.5);
        //         this.enemyGroup.add(this.guest);
        //     }
        // });
